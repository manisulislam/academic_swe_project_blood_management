...
def request_blood(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            blood_request.user = request.user  # associate the request with logged-in user
            blood_request.save()


            # testing request blood mail
            mail_subject='Request Blood  Successfully message'
            ...
            send_email.send()
            return redirect('request_history')  # your blood request history page
    else:
